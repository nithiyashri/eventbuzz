...
function Event() {
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/events1/${params.symp_id}`, {
                            ...
                            <div class="card-media">
                                ...
                                <div class="card-media-body">
                                    <div class="card-media-body-top">
                                        <span class="subtle">Round 1 : {user.round1_date} : {user.round1_time}</span><br />
                                        <span class="subtle">Round 2 : {user.round2_date} : {user.round2_time}</span>
